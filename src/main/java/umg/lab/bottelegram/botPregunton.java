...
public class botPregunton extends TelegramLongPollingBot {
    ...
    public botPregunton() {
        ...
        preguntas.put("SECTION_4", new String[]{"4.1 Eri feliz?", "4.2 Y que te gusta comer?", "4.3 que rico, y como te gusta?", "4.4 que fino, eres hombre o mujer?", "4.5 a que chido, y tienes pareja?", "4.6 el admin busca una si eres mujer, aceptas? y por que no?"});
    }
