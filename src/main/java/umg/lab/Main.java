...
import umg.lab.bottelegram.BotCuestionario;
import umg.lab.bottelegram.BotRegistra;
import umg.lab.bottelegram.botPregunton;
...
//    }
    ...
    public static void main(String[] args) {
        try {
            ...
            //Bot bot = new Bot();
            BotCuestionario botito = new BotCuestionario();
            botsApi.registerBot(botito);
